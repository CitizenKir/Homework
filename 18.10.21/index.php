...
if(($_SESSION['login'] =='Kirill') && ($_SESSION['password'] == '1234')) {
    echo 'Последняя посещенная страница: ' . $_SESSION['page'];
}
else{
    echo 'Авторизуйтесь, чтобы увидеть последнюю посещенную страницу';
}
...
?>
<!DOCTYPE html>
<html lang="ru" style="background-color:<? echo $color;?>">
<head>
    <meta charset="UTF-8">
